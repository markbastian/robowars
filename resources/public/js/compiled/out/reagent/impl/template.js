...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__27049__auto__,writer__27050__auto__,opt__27051__auto__){
return cljs.core._write.call(null,writer__27050__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__26397__auto__ = reagent.impl.template.named_QMARK_.call(null,x);
...
var or__26397__auto__ = reagent.impl.template.hiccup_tag_QMARK_.call(null,x);
if(cljs.core.truth_(or__26397__auto__)){
return or__26397__auto__;
} else {
...
var temp__6505__auto__ = reagent.impl.template.obj_get.call(null,reagent.impl.template.prop_name_cache,cljs.core.name.call(null,k));
...
var G__38316 = o;
(G__38316[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
while (G__38318__i < G__38318__a.length) {G__38318__a[G__38318__i] = arguments[G__38318__i + 0]; ++G__38318__i;}
  args = new cljs.core.IndexedSeq(G__38318__a,0);
} 
...
var args = cljs.core.seq(arglist__38319);
...
var old_38320 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_38320))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_38320)].join(''):class$));
} else {
}
...
var temp__6507__auto__ = (this$["cljsInputValue"]);
if((temp__6507__auto__ == null)){
return null;
} else {
var value = temp__6507__auto__;
(this$["cljsInputDirty"] = false);

var node = (this$["getDOMNode"])();
var node_value = (node["value"]);
if(cljs.core.not_EQ_.call(null,value,node_value)){
if(cljs.core.not.call(null,(function (){var and__26385__auto__ = (node === document.activeElement);
if(and__26385__auto__){
var and__26385__auto____$1 = reagent.impl.template.has_selection_api_QMARK_.call(null,(node["type"]));
...
if(cljs.core.truth_((function (){var and__26385__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__38323 = jsprops;
(G__38323["defaultValue"] = value);

(G__38323["onChange"] = ((function (G__38323,v,value,on_change){
return (function (p1__38321_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__38321_SHARP_);
});})(G__38323,v,value,on_change))
);
...
var vec__38327 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__38327,(0),null);
var id = cljs.core.nth.call(null,vec__38327,(1),null);
var class$ = cljs.core.nth.call(null,vec__38327,(2),null);
...
var temp__6505__auto__ = reagent.impl.util.cached_react_class.call(null,tag);
if((temp__6505__auto__ == null)){
...
var temp__6505__auto__ = (function (){var G__38333 = cljs.core.meta.call(null,v);
if((G__38333 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__38333);
}
})();
if((temp__6505__auto__ == null)){
...
var jsprops = ({"argv": v});
var G__38335_38336 = v;
var G__38335_38337__$1 = (((G__38335_38336 == null))?null:reagent.impl.template.key_from_vec.call(null,G__38335_38336));
if((G__38335_38337__$1 == null)){
} else {
(jsprops["key"] = G__38335_38337__$1);
}
...
var temp__6505__auto__ = reagent.impl.template.obj_get.call(null,reagent.impl.template.tag_name_cache,x);
if((temp__6505__auto__ == null)){
...
var p = (function (){var temp__6505__auto__ = (function (){var G__38340 = cljs.core.meta.call(null,argv);
if((G__38340 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__38340);
}
})();
if((temp__6505__auto__ == null)){
return jsprops;
} else {
var key = temp__6505__auto__;
var G__38341 = (((jsprops == null))?({}):jsprops);
(G__38341["key"] = key);
...
var G__38342 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__38342;
continue;
}
} else {
...
var n__27410__auto___38343 = a.length;
var i_38344 = (0);
while(true){
if((i_38344 < n__27410__auto___38343)){
(a[i_38344] = reagent.impl.template.as_element.call(null,(a[i_38344])));

var G__38345 = (i_38344 + (1));
i_38344 = G__38345;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__27410__auto___38346 = a.length;
var i_38347 = (0);
while(true){
if((i_38347 < n__27410__auto___38346)){
var val_38348 = (a[i_38347]);
if((cljs.core.vector_QMARK_.call(null,val_38348)) && ((reagent.impl.template.key_from_vec.call(null,val_38348) == null))){
(o["no-key"] = true);
} else {
}

(a[i_38347] = reagent.impl.template.as_element.call(null,val_38348));

var G__38349 = (i_38347 + (1));
i_38347 = G__38349;
continue;
} else {
}
...
if(cljs.core.truth_((function (){var and__26385__auto__ = cljs.core.not.call(null,reagent.impl.component._STAR_non_reactive_STAR_);
if(and__26385__auto__){
return (ctx["no-key"]);
} else {
return and__26385__auto__;
...
var G__38351 = (cljs.core.count.call(null,argv) - first_child);
switch (G__38351) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__38351){
...
//# sourceMappingURL=template.js.map?rel=1474693970068